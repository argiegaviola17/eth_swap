...
import JorgienaToken from "../abis/JorgienaToken.json";
...
class App extends Component {
  ...
  async componentWillMount(){
    await this.loadWeb3(window.web3);
  ...
  async loadBlockchainData(){
    ...
    const tokenData = JorgienaToken.networks[networkId];
    if(tokenData){
      const token = new web3.eth.Contract(JorgienaToken.abi, tokenData.address)
      this.setState({ token })
